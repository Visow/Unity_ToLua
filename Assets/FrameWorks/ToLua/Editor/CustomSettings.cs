...
{
    public static string FrameworkPath = VisowFrameWork.CoreConst.FrameWorksRoot;
    ...
    public static string toluaLuaDir = LuaConst.toluaDir;
    ...
    {                
        ...
        _GT(typeof(VisowFrameWork.LuaHelper)).SetNameSpace("cs"),
        _GT(typeof(VisowFrameWork.LuaManager)).SetNameSpace("cs"),
        ...
        _GT(typeof(VisowFrameWork.NetWorkManager)).SetNameSpace("cs"),
        _GT(typeof(VisowFrameWork.ByteBuffer)).SetNameSpace("cs"),
        _GT(typeof(VisowFrameWork.EventListener)).SetNameSpace("cs"),
        _GT(typeof(VisowFrameWork.LoadingManager)).SetNameSpace("cs"),
        
        _GT(typeof(FootMan)).SetNameSpace("ga"),
