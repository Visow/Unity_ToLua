...
public class VisowFrameWork_ResourceManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(VisowFrameWork.ResourceManager), typeof(VisowFrameWork.ManagerBase));
	...
	static int Initialize(IntPtr L)
	{
		try
		{
			...
			VisowFrameWork.ResourceManager obj = (VisowFrameWork.ResourceManager)ToLua.CheckObject<VisowFrameWork.ResourceManager>(L, 1);
			obj.Initialize();
			return 0;
		}
		catch (Exception e)
