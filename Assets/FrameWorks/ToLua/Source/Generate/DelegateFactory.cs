...
public class DelegateFactory
{
	...
	class VisowFrameWork_EventListener_VoidDelegate_Event : LuaDelegate
	{
		...
		public VisowFrameWork_EventListener_VoidDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public VisowFrameWork.EventListener.VoidDelegate VisowFrameWork_EventListener_VoidDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			VisowFrameWork.EventListener.VoidDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.PointerEventData param1) { };
			return fn;
		}

		if(!flag)
		{
			VisowFrameWork_EventListener_VoidDelegate_Event target = new VisowFrameWork_EventListener_VoidDelegate_Event(func);
			VisowFrameWork.EventListener.VoidDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			VisowFrameWork_EventListener_VoidDelegate_Event target = new VisowFrameWork_EventListener_VoidDelegate_Event(func, self);
			VisowFrameWork.EventListener.VoidDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_VisowFrameWork_EventListener_VoidDelegate(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(VisowFrameWork.EventListener.VoidDelegate), L, pos);
	}
