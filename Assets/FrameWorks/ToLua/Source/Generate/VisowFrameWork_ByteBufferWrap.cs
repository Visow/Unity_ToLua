...
public class VisowFrameWork_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(VisowFrameWork.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateVisowFrameWork_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateVisowFrameWork_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				VisowFrameWork.ByteBuffer obj = new VisowFrameWork.ByteBuffer();
			...
			else if (count == 1)
			{
				...
				VisowFrameWork.ByteBuffer obj = new VisowFrameWork.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: VisowFrameWork.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Apped(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			VisowFrameWork.ByteBuffer obj = (VisowFrameWork.ByteBuffer)ToLua.CheckObject<VisowFrameWork.ByteBuffer>(L, 1);
			VisowFrameWork.ByteBuffer arg0 = (VisowFrameWork.ByteBuffer)ToLua.CheckObject<VisowFrameWork.ByteBuffer>(L, 2);
			obj.Apped(arg0);
			return 0;
		}
		catch (Exception e)
