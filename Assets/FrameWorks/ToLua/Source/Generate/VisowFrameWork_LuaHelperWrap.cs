...
public class VisowFrameWork_LuaHelperWrap
{
	...
	static int GetType(IntPtr L)
	{
		try
		{
			...
			System.Type o = VisowFrameWork.LuaHelper.GetType(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int OnCallLuaFunc(IntPtr L)
	{
		try
		{
			...
			VisowFrameWork.LuaHelper.OnCallLuaFunc(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int OnJsonCallFunc(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			LuaFunction arg1 = ToLua.CheckLuaFunction(L, 2);
			VisowFrameWork.LuaHelper.OnJsonCallFunc(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
