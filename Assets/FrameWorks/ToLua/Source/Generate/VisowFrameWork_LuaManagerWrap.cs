...
public class VisowFrameWork_LuaManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(VisowFrameWork.LuaManager), typeof(VisowFrameWork.ManagerBase));
	...
	static int InitStart(IntPtr L)
	{
		try
		{
			...
			VisowFrameWork.LuaManager obj = (VisowFrameWork.LuaManager)ToLua.CheckObject<VisowFrameWork.LuaManager>(L, 1);
			obj.InitStart();
			return 0;
		}
		catch (Exception e)
